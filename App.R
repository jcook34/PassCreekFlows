...
# 5990484137476096 PC1 staff
# 6102784244711424 PC1 troll

#Notes:
#to get PC1 staff
#depth -1.18 #depth comes out in meters this is all in feet

#to PC1 flow use
#if depth below .6 use 24.787*depth^2 + 0.9622*depth - 0.0162 (equation)
#else 1.7004* exp(2.8282*depth) (equation)
